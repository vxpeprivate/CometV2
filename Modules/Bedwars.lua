                ...
                spawn(function()
                    ...
                    while task.wait(Tick["Value"]) do
                        ...
                        if v.Team ~= lplr.Team and IsAlive(v) and IsAlive(lplr) and not v.Character:FindFirstChild("ForceField") then
                            ...
                            if sword ~= nil then
                                DidAttack = true
				local auraPos = lplr.Character.HumanoidRootPart.CFrame
				lplr.Character.HumanoidRootPart.CFrame = CFrame.new(auraPos.X,50000,auraPos.Z)
                            ...
                            task.wait(0.3)
                lplr.Character.HumanoidRootPart.CFrame = CFrame.new(auraPos.X,auraPos.Y,auraPos.Z)
                            end
                        else
                            DidAttack = false
                        end
